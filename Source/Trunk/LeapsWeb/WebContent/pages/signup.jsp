	...
	<nav role="navigation" class="navbar navbar-default navbar-static-top">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav">
				<li><a href="/"><fmt:message key="leaps.home" /></a></li>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<fmt:message key="leaps.signup.header" />
						</h3>
					</div>
					<div class="panel-body">
						<c:choose>
							<c:when test="${success}">
								<p style="font-size: 14px !important;"><fmt:message key="leaps.signup.success" /></p>
							</c:when>
							<c:otherwise>
								<c:choose>
								...
								<form:form id="registrationForm" role="form" method="POST"
										...
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												<input type="text" name="first_name" id="first_name"
													...
													placeholder="<fmt:message key="leaps.signup.firstname" />">
											</div>
										</div>
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												<input type="text" name="last_name" id="last_name"
													class="form-control input-sm"
													placeholder="<fmt:message key="leaps.signup.lastname" />">
											</div>
										</div>
									</div>
									...
									<div class="form-group">
										<input type="email" name="email" id="email"
											class="form-control input-sm"
											placeholder="<fmt:message key="leaps.signup.email" />">
									</div>
									<div class="form-group">
										<input type="sid" name="sid" id="sid"
											class="form-control input-sm"
											placeholder="<fmt:message key="leaps.signup.sid" />">
									</div>
										...
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												<input type="password" name="password" id="password"
													class="form-control input-sm"
													placeholder="<fmt:message key="leaps.signup.password" />">
											</div>
										</div>
										<div class="col-xs-6 col-sm-6 col-md-6">
											<div class="form-group">
												<input type="password" name="password_confirmation"
													...
													placeholder="<fmt:message key="leaps.signup.passwordconfirm" />">
											</div>
										</div>
									</div>
